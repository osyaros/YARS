...
namespace yar_bfng
{
    public struct Product
    {
        ...
        public Product(string name_, string mark_, int price_, string type_, string web_, string socket_)
        {
            name = name_;
            mark = mark_;
            price = price_;
    ...
    public partial class CategoryForm : Form
    {
        ...
        {
            string[] lines =
                System.IO.File.ReadAllLines("Пользователи.txt");
            Users = new Dictionary<string, string>();
            for (int i = 0; i + 1 < lines.Length; i = i + 2)
            {
                Users.Add(lines[i], lines[i + 1]);
            }
        ...
        {
            Dictionary<string, string> words = StartForm.EnWords;
            if (StartForm.language == "Ru") words = StartForm.RuWords;
        ...
        {
            SvyazForm f = new SvyazForm();
            f.Show();
        }
       public static string login = "Вася";
